...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___assets'
  | 'pluginCreator___pluginOptions___vendors'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___assets'
  | 'pluginOptions___vendors'
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  vendors?: Maybe<StringQueryOperatorInput>;
...
export type HeroImgQueryVariables = Exact<{ [key: string]: never; }>;


export type HeroImgQuery = { allFile: { edges: Array<{ node: { childImageSharp?: Maybe<{ fluid?: Maybe<(
